...
LIB_SRCS := src/alloc.c src/errcode.c src/log.c src/prefix4.c src/prefix6.c src/capability.c
...
TEST_SRCS := tests/test_alloc_log.c tests/test_vec.c tests/test_prefix.c tests/test_capability.c
